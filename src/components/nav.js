...
const Nav = () => {
  ...
  useOnClickOutside(m1, () => setShowModal(false))
  useOnClickOutside(m2, () => setShowModal1(false))
  return (
    <>
      <div className="desktop-nav">
          ...
          <ul>
            <li className="inline-block relative">
              <a
                ...
                href="https://www.theapesociety.io"
                target="_blank"
              >
                Home
              </a>
        ...
        {showModal ? (
          <>
            <div
              ref={m1}
              className="modal absolute top-24 md:max-w-3xl mx-auto flex-col md:flex-row flex z-50 left-0 right-0"
            >
      ...
      <div className="mobile-nav">
        ...
        <div
          className={`top-0 right-0 w-[45vw] bg-black overflow-y-scroll p-10 text-white fixed h-full z-40 ease-in-out duration-300 ${
            showSidebar ? "translate-x-0 " : "translate-x-full"
          } sidenav`}
        >
          <nav>
            <ul>
              <li className="inline-block relative w-full mb-8">
                <a
